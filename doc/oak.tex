...
Let $N$ be the error space dimension, \emph{i.e} the ensemble size, and $m$ the observation space dimension. The best linear unbiased estimator (BLUE) of the model's state vector
