...
&=& 
\mathbf S ^f {\mathbf S ^f}^T \mathbf H ^T \left[(\mathbf H \mathbf S^f)(\mathbf H \mathbf S^f)^T+\mathbf R  \right]^{-1}\label{beforeSherman}\\
&=&
...
\mathbf{P}^a
&=&
\mathbf{S}^f\left[\mathbf I-(\mathbf I+{\mathbf{U\Lambda U^T})}^{-1}\mathbf{U\Lambda U^T}\right]{\mathbf{S}^f}^T\\
&=&\mathbf{S}^f\left[\mathbf I-(1+{\mathbf{U\Lambda U^T})}^{-1}(\mathbf{U\Lambda U^T}+1-1)\right]{\mathbf{S}^f}^T \label{PaSfSft2} \\
